        ...
        const fetchData = async () => {
            try {
                ...
                if(routeCoordinates !== null && routeCoordinates !== undefined){
                    //sconst response = await axios.get(`https://api.geoapify.com/v1/routing?waypoints=${fromWaypoint.join(',')}|${toWaypoint.join(',')}&mode=drive&details=instruction_details&apiKey=${apikey}`);
