        ...
        <main className="flex-1">
            ...
            <div className="container px-4 md:px-6 ">
              <div className='flex items-center gap-10 '>
                <div className='tags'>
                  ...
                  Unlock convenience at your fingertips. Discover nearby services tailored to your preferences instantly.
                  </p>
          ...
          <section className="w-full px-10 py-10">
            ...
            <div className='flex py-10 gap-10 text-center'>
              ...
              <div className="flex flex-col items-center py-14  justify-center bg-white border rounded-xl shadow-xl p-6 hover:bg-[#bc76fd]  text-gray-400 hover:text-white transition ease-in">
                <div className="text-4xl mb-4 bg-purple-400 text-white rounded-full p-3">{<GoStarFill size="0.9em"  />}</div>
                <h2 className="text-xl font-semibold mb-2 text-gray-800">Reviews and Ratings</h2>
                <p className="py-2 px-5">Make informed decisions with insights from fellow users, helping you choose the best services with confidence and trust.</p>
              </div>

              <div className="flex flex-col items-center py-14  justify-center bg-white border rounded-xl shadow-xl p-6 hover:bg-[#bc76fd] text-gray-400 hover:text-white transition ease-in">
                <div className="text-4xl mb-4 bg-purple-400 text-white rounded-full p-3">{<FaMapLocationDot size="0.9em"  />}</div>
                <h2 className="text-xl font-semibold mb-2 text-gray-800">Visual Integration</h2>
                <p className="py-2 px-5">Visualize nearby services on an interactive map for effortless navigation and seamless exploration of your surroundings.</p>
              </div>
            </div>
            ...
            <div className="container flex flex-col items-center px-4 text-center gap-3  md:flex-row">
              ...
              <div className="grid gap-4 max-w-prose p-9 ">
                <div className="space-y-2">
                  <h2 className="text-2xl font-bold tracking-tighter sm:text-4xl">ABOUT US</h2>
                </div>
                <p className="text-gray-500 md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed dark:text-gray-400 px-12">
                    Discover local services effortlessly. Our platform simplifies your search, offering personalized recommendations and 
                    intuitive tools for seamless exploration. Experience convenience like never before. Embark on effortless exploration with our platform, designed to simplify your search for local services. Whether it's dining, refueling, or more, our personalized recommendations and intuitive 
                    tools ensure convenience at every step of your journey. Start discovering today!
                </p>
              </div>
            </div>
          </section>
              ...
              <div className="mx-auto grid max-w-sm items-start gap-8 sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-4">
                ...
                <div className="flex flex-col items-center justify-center space-y-2">
                  ...
                  <div className="space-y-2 text-center">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                    Access directions or contact details for seamless interaction.
                    </p>
                  </div>
                </div>
              </div>
